...
- Solves a multi-variable optimization problem: _How to fulfill 100% of the macros and micros for the week, using the user's preferred foods, without exceeding the budget limitation?_
